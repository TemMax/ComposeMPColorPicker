...
import com.duglasher.colorpicker.toRadian
...
internal fun HarmonyColorMagnifiers(
    ...
    hsvColor.getColors(harmonyMode).forEach { color ->
        ...
        Magnifier(
            position = positionForColor.value,
            color = color,
            diameter = diameterDp * diameterHarmonyColor
        )
    }
    Magnifier(
        position = positionAnimated.value,
        color = hsvColor,
        diameter = animatedDiameter.value
    )
}
